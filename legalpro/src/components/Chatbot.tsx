...
function getBotResponse(input: string): string {
  ...
  if (q.includes('hello') || q.includes('hi') || q.includes('hey')) {
    return 'Hello! 👋 I\'m your Juryfy AI assistant. I can help you with:\n• [Cases](/app/cases) — Case management & status\n• [Calendar](/app/calendar) — Hearing schedules\n• [Lawyers Near You](/app/profiling) — Find lawyers\n• [AI Analyser](/app/analyser) — Legal analysis\n• [Billing](/app/billing) — Invoices & payments\n• [Compliance](/app/compliance) — Deadlines & compliance\n• [FIR Intelligence Hub](/app/fir) — FIR records\n\nWhat would you like to know?';
  }
