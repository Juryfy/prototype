...
export function HomePage() {
  ...
  // Button classes
  const btnClass = 'px-3 py-1.5 rounded-lg bg-accent-primary/20 text-accent-primary hover:bg-accent-primary hover:text-white text-xs font-medium transition-colors';
